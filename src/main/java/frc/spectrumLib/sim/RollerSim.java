...
public class RollerSim implements Mountable {
    ...
    public void simulationPeriodic() { // double x, double y) {
        ...
        double rotationsPerSecond = rollerSim.getAngularVelocity() / (2.0 * Math.PI);
        ...
        double rpm = Units.radiansPerSecondToRotationsPerMinute(rollerSim.getAngularVelocity()) / 2;
        rollerViz.setAngle(
