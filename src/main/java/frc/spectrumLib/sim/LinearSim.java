...
public class LinearSim implements Mount, Mountable {
    ...
    private double getRotationPerSec() {
        return (elevatorSim.getVelocity() / (2 * Math.PI * config.getDrumRadius()))
                * config.getElevatorGearing();
    }

    private double getRotations() {
        return (elevatorSim.getPosition() / (2 * Math.PI * config.getDrumRadius()))
                * config.getElevatorGearing();
    }
    ...
    public void simulationPeriodic() {
        ...
        double displacement = elevatorSim.getPosition();
    ...
    public double getDisplacementX() {
        ...
        return elevatorSim.getPosition() * Math.cos(Math.toRadians(angle))
    ...
    public double getDisplacementY() {
        ...
        return elevatorSim.getPosition() * Math.sin(Math.toRadians(angle))
