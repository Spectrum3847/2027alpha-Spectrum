...
public class Auton {
    ...
    public Command autoScore() {
        return (Commands.race(SwerveStates.reefAimDriveVisionXY(), new WaitCommand(5))
    ...
    public Command autonScore() {
        return Commands.sequence(Commands.wait(.75), RobotStates.actionPrepState.setFalse())
                .withName("Auton.L4Score");
    }

    public Command fullSequenceL4score() {
        return Commands.wait(0.15)
                .andThen(
                        RobotStates.coral
                                .setTrue()
    ...
    public Command SpectrumAuton(String autoName, boolean mirrored) {
        ...
        return (Commands.wait(0.01).andThen(autoCommand)).withName(autoName);
    }

    public Command SpectrumAuton(String autoName, boolean mirrored, double duration) {
        Command autoCommand = new PathPlannerAuto(autoName, mirrored);
        return Commands.wait(0.01)
                .andThen(autoCommand)
